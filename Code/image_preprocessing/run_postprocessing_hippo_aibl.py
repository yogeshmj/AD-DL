...
## run the pipeline
##
caps_directory= '/network/lustre/dtlake01/aramis/users/clinica/CLINICA_datasets/CAPS/Frontiers_DL/AIBL'
tsv='/network/lustre/iss01/home/junhao.wen/Project/AD-DL/tsv_files/tsv_after_qc/AIBL_after_qc.tsv'
working_dir = '/network/lustre/dtlake01/aramis/users/clinica/CLINICA_datasets/CAPS/Frontiers_DL/working_dir/AIBL'
